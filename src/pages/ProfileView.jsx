...
export default function ProfileView() {
  ...
  const activeTab = TABS.find((tab) => tab.path === location.pathname)?.key || (location.pathname.startsWith("/my-courses/certificates") ? "certificates" : "profile");
  ...
  const certificateCourses = (myCourses || []).filter((course) => certificateFor(course));
