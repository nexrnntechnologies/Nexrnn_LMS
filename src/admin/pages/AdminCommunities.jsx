...
export default function AdminCommunities() {
  ...
  return <div className="max-w-6xl mx-auto px-8 py-10">
    <div className="flex items-center justify-between gap-4 mb-6"><div><p className="text-xs font-bold tracking-[0.2em] text-slate-400 uppercase mb-2">Community hub</p><h1 className="text-2xl font-extrabold text-slate-900">Communities</h1><p className="text-sm text-slate-500 mt-1">Create communities and fully manage their announcements.</p></div><button onClick={openCreate} className="flex items-center gap-1.5 text-sm font-semibold text-white px-4 py-2 rounded-md hover:opacity-90" style={{ backgroundColor: BLUE }}><Plus size={15} /> Add Community</button></div>
